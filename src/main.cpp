...
const string strMessageMagic = "Bux Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
  ...
  if(nBestHeight > 0  && nBestHeight  <=100 )
  {
       ...
       if(nBestHeight == 41)
        {
            return  ((nSubsidy5 *  nSubsidy3)  + nFees );
         }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The times 01.5.2018. Buxnew project is here.";
        CTransaction txNew;
        txNew.nTime = 1525261884;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525261884;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1531060138 : 1531060138 ;
...
printf("block.nNonce = %u \n", block.nNonce);
        ...
        assert(block.hashMerkleRoot == uint256("0xe51adb74ee3a67f053374e0e2995985eb73ae2b45d64dce983429600f91bfe32"));
